                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item active">Daftar Jatah Cuti</li>
                            </ol>
                        </div>
                    </div>
                </div><!-- /.container-fluid -->
            ...
            <section class="content">
                ...
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Table Edit Jatah Cuti</h3>
                    ...
                    <div class="card-body">
                        <form class="forms-sample" action="{{ url('admin/jatahcuti/update', $jatahcuti->id) }}"
                            method="POST">
                            @csrf
                            @method('put')
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" id="pegawai_id" name="pegawai_id"
                                        placeholder="Masukkan Pegawai ID" value="{{ $jatahcuti->pegawai }}">
                                </div>
                            </div>
