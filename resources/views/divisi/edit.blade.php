    ...
    <section class="content">
      ...
      <div class="card">
        <div class="card-header">
          <h3 class="card-title">Table Edit Divisi</h3>
        ...
        <div class="card-body">
        <form class="forms-sample" action="{{ url('admin/divisi/update', $divisi->id) }}" method="POST">
            @csrf
            @method('put')
          ...
          <div class="form-group row">
              ...
              <div class="col-sm-8">
                  <input type="text" class="form-control" id="kode" name="kode"
                      placeholder="Masukkan Longitude" value="{{ $divisi->kode }}">
              </div>
          </div>
          <div class="form-group row">
