...
class KategoriUmkmController extends Controller
{
    ...
    {
        $kategoriumkm = Kategori_Umkm::find($id);
    ...
    {
        $kategoriumkm = Kategori_Umkm::find($id);
        $kategoriumkm->delete();return redirect('admin/kategoriumkm')->with('pesan', 'Data Berhasil di Hapus');
    }
}
